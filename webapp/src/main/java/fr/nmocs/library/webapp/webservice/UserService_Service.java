 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://webservice.library.nmocs.fr/", wsdlLocation = "http://localhost:8080/Library_webservice/services/user?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://webservice.library.nmocs.fr/", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Library_webservice/services/user?wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://webservice.library.nmocs.fr/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.library.nmocs.fr/", "UserServicePort"), UserService.class, features);
    }
