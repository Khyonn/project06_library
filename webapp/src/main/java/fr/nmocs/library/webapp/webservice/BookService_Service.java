 ...
 * 
 */
@WebServiceClient(name = "BookService", targetNamespace = "http://webservice.library.nmocs.fr/", wsdlLocation = "http://localhost:8080/Library_webservice/services/book?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BOOKSERVICE_QNAME = new QName("http://webservice.library.nmocs.fr/", "BookService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Library_webservice/services/book?wsdl");
    ...
    public BookService getBookServicePort() {
        return super.getPort(new QName("http://webservice.library.nmocs.fr/", "BookServicePort"), BookService.class);
    }
    ...
    public BookService getBookServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.library.nmocs.fr/", "BookServicePort"), BookService.class, features);
    }
